...
import { editAddress, postAddress } from "../Redux/Action/addressAction";
...
export default function EditAddress({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      dispatch(postAddress(credential, id))
        .then(() => {
          setTimeout(() => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.textInputContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setCredential({ ...credential, state: text })}
        />
        <TextInput
          placeholder="Country"
          style={styles.textInput}
          value={credential.country}
          onChangeText={(text) => setCredential({ ...credential, country: text })}
        />
        <TextInput
          placeholder="Pincode"
          style={styles.textInput}
      ...
      <Pressable style={styles.btnContainer} onPress={handleSubmit}>
        <Text style={styles.btn}>{loading ? "Adding..." : "Add"}</Text>
      </Pressable>
    </SafeAreaView>
  );
}
